...
data = dict(
    ...
    train=dict(
        ...
        classes=('line', ),
        ann_file=
        '/content/drive/MyDrive/project1/phase1/LineFormer_ft/dataset/V2/train_coco_annot.json',
        img_prefix=
        '/content/drive/MyDrive/project1/phase1/LineFormer_ft/dataset/V2/train',
        pipeline=[
            dict(type='LoadImageFromFile', to_float32=True),
            dict(
    ...
    test=dict(
        ...
        classes=('line', ),
        ann_file=
        '/content/drive/MyDrive/project1/phase1/LineFormer_ft/dataset/V2/val_coco_annot.json',
        img_prefix=
        '/content/drive/MyDrive/project1/phase1/LineFormer_ft/dataset/V2/val',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
evaluation = dict(interval=13, metric=['segm'], save_best='segm_mAP')
...
log_level = 'INFO'
load_from = '/content/drive/MyDrive/project1/phase1/DiagramDetection/model/LineFormer.pth'
resume_from = None
workflow = [('train', 5000)]
...
work_dir = './work_dirs/lineformer_config'
auto_resume = False
gpu_ids = [0]
